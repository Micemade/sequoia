	...
	<a href="<?php echo get_term_link( $category->slug, 'product_cat' ); ?>">
		...
		if ( $thumbnail_id ) {
			...
			if( $img_width && $img_height ) {
				...
				echo '<div class="entry-image"><img src="' . bfi_thumb( $image, $params ). '" alt="'.$category->name.'" /></div>';
			
			}else{
				
				echo '<div class="entry-image"><img src="' . $image . '" alt="' . $category->name . '" width="' . $dimensions['width'] . '" height="' . $dimensions['height'] . '" /></div>';
			}
