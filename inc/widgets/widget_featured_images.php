...
class Widget_Featured_Post_Images extends WP_Widget {
	...
	function __construct(){
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'featured-image-widget', 'description' => __('A widget displaying featured content images.', 'sequoia') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'featured-content-images' );

		/* Create the widget. */
		parent::__construct( 'featured-content-images', __('Featured content images', 'sequoia'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 
			'title' => __('Featured content', 'sequoia'),
			'num' => 6,
			'width'=>'45%',
			'image_size' => 'thumbnail' ,
			'types'  => 'post'
		...
		*/
		...
		<p>
			<label for="<?php echo $this->get_field_id('types'); ?>"><?php echo __( 'Post type:','sequoia' ); ?></label>
