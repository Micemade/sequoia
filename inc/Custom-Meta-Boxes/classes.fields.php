...
abstract class AS_Field {
	...
	public function display() {
		...
		if ( $this->args['repeatable'] ) {
			...
			<button class="button repeat-field"><?php esc_html_e( 'Add New', 'sequoia' ); ?></button>
	...
	public function html() { 
		...
		<div class="as-file-wrap" <?php echo 'data-type="' . esc_attr( $data_type ) . '"'; ?>>
			...
			<button class="button as-file-upload <?php echo esc_attr( $this->get_value() ) ? 'hidden' : '' ?>">
				<?php esc_html_e( 'Add File', 'sequoia' ); ?>
			</button>
	...
	public function html() {
		...
		<div class="as-file-wrap" style="<?php echo esc_attr( $styles ); ?>" data-type="<?php echo esc_attr( $data_type ); ?>">
			...
			<button class="button as-file-upload <?php echo esc_attr( $this->get_value() ) ? 'hidden' : '' ?>" data-nonce="<?php echo wp_create_nonce( 'as-file-upload-nonce' ); ?>">
				<?php esc_html_e( 'Add Image', 'sequoia' ); ?>
			</button>
	...
	public function output_field() {
		...
		>
			...
			<?php if ( ! empty( $this->args['allow_none'] ) ) : ?>
				<option value=""><?php echo esc_html_x( 'None', 'select field', 'sequoia' ) ?></option>
			<?php endif; ?>
	...
	public function output_script() {
		...
		<script type="text/javascript">
			...
			(function($) {
				...
				options.placeholder = <?php echo json_encode( __( 'Type to search', 'sequoia' ) ) ?>;
	...
	public function display() {
		...
		if ( $this->args['repeatable'] ) {
			...
			$this->value = ''; ?>
				...
				<button class="button repeat-field"><?php esc_html_e( 'Add New Group', 'sequoia' ); ?></button>
