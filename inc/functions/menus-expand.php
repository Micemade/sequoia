 ...
 * MENUS EXPAND
 *
 * expanding and colapsing menus in WP menus admin
 * forked from plugin "Expandable Menus" from Dustin Dempsey (http://playforward.net)
 *
 */
	// out function
	function AS_menus_script_head_code(){
		...
		echo '
			<style>
				...
				.hovering dt.menu-item-handle:after {
					font: 400 20px/1.6em dashicons!important;
					content: "\f132";
					font-size: 16px;
	...
	add_action( 'admin_head', 'AS_menus_script_head_code' );
